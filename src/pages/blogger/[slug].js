...
import { Avatar, Box, Center, Divider, Flex, Image, Spacer, Text, VStack, Wrap } from '@chakra-ui/react'
        ...
        <HomeLayout>
            ...
            >
                ...
                <Box mb={8}>
                    ...
                    <Box w='full' zIndex={999} py={3} mb='10' bg={'white'} fontWeight='bold' borderColor='blackAlpha.100' rounded='sm'>
                        <Flex gap={2}>
                            <Avatar rounded={'sm'} size={'lg'} name={blogger} />
                            <Box>
                                <Title order={3}>{blogger}</Title>
                                <Wrap spacingX={4}>
                                    <Text fontSize={'12px'} color='blackAlpha.500'>১৪ জন অনুসরন করছে</Text>
                                    <Text fontSize={'12px'} color='blackAlpha.500'>পোস্ট লিখেছেন ২৩৯ টি</Text>
                                    <Text fontSize={'12px'} color='blackAlpha.500'>মন্তব্য করেছেন ৭৮০ টি</Text>
                                    <Text fontSize={'12px'} color='blackAlpha.500'>মন্তব্য পেয়েছেন ৭৮০ টি</Text>
                                </Wrap>
                            </Box>
                        </Flex>
                        {/* <Divider my={2} /> */}
                        <Blockquote>
                            <Text fontSize={'15px'} color={'blackAlpha.600'}>সরকারি চাকরিতে আবেদন ফি বাড়ানো হইছে আজ থেকে সাত দিন পূর্বে । তেরো এবং ষোল গ্রেডের আবেদন ফি দ্বিগুণ করা হয়েছে । এগারো ও বারো গ্রেডে পূর্বে আবেদন ফি নির্ধারণ করা না থাকলে সেটা এখন তিনশো টাকা করা হয়েছে</Text>
                        </Blockquote>
                    </Box>
